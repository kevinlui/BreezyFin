...
namespace System.Collections.Concurrent
{
    ...
    /*
    public class ObservableDictionaryValues<TValue> : Dictionary<TValue>, INotifyCollectionChanged
    {
        public ObservableDictionaryValues(ICollection<TValue> dictValues)
        { 
        }
    }
     */
